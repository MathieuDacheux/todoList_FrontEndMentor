...
theme.addEventListener('click', (e) => {
  ...
  if (e.target.src.includes('./public/assets/icons//icon-moon.svg')) e.target.src = './images/icon-sun.svg'
  else e.target.src = './public/assets/icons//icon-moon.svg'
...
function createTodo(todoText, isChecked) {
  ...
  checkImage.src = "./public/assets/icons/icon-check.svg"

  const crossImage = document.createElement('img')
  crossImage.src = "./public/assets/icons/icon-cross.svg"
